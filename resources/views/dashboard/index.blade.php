                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3 pb-3"
                        ...
                        <div>
                            ...
                            <div style="font-size:20px;font-weight:700">৳{{ number_format($totalRevenue, 2) }}</div>
                        </div>
                        <div class="stat-icon"
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3 pb-3"
                        ...
                        <div>
                            ...
                            <div style="font-size:20px;font-weight:700">{{ $totalMenuItems }}</div>
                        </div>
                        <div class="stat-icon"
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3 pb-3"
                        ...
                        <div>
                            ...
                            <div style="font-size:16px;font-weight:700">{{ $mostPopularDish?->name ?? 'No sales yet' }}
                            </div>
                            <div style="font-size:12px;color:var(--text-muted)">{{ $mostPopularDish?->total_quantity ?? 0 }}
                                sold</div>
                        </div>
                        <div class="stat-icon"
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <div style="font-size:20px;font-weight:700">{{ $totalStaff }}</div>
                        </div>
                        <div class="stat-icon"
                                ...
                                <tbody>
                                    @foreach ($pendingOrders->take(6) as $order)
                                        <tr>
                                            ...
                                            <td><span
                                                    class="status-badge {{ $order->status }}">{{ ucfirst($order->status) }}</span>
                                            </td>
