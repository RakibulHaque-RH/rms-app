                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @foreach ($menuItems as $category => $items)
                            <h6 class="fw-bold text-uppercase mb-3 mt-2"
                                style="color:var(--primary);font-size:13px;letter-spacing:1px">
                                            ...
                                            <div class="mt-2 qty-control d-none">
                                                <div class="input-group input-group-sm" onclick="event.stopPropagation()">
                                                    ...
                                                    <input type="number" class="form-control text-center"
                                                        id="qty-{{ $item->id }}" min="1" value="1"
                                                        style="max-width:60px" onchange="updateOrderSummary()">
                                                    <button type="button" class="btn btn-outline-secondary"
                                                        onclick="changeQty({{ $item->id }}, 1)">+</button>
                                                </div>
                                            </div>
