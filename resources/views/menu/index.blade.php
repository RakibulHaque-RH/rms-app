        ...
        @forelse($menuItems as $item)
            <div class="col-xl-3 col-lg-4 col-md-6 fade-in">
                <div class="card h-100" style="overflow:hidden">
                    ...
                    @else
                        <div
                            style="height:180px;background:linear-gradient(135deg,#e0e7ff,#c7d2fe);display:flex;align-items:center;justify-content:center">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <span class="badge"
                                style="background:rgba(99,102,241,.1);color:var(--primary);font-size:11px">{{ $item->category }}</span>
